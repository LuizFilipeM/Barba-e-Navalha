...
export function EditBarbershop() {
  ...
  async function handleSignUpBarber() {
    ...
    const response = await api.post(`/local-edit/${user.id}/`, dados)
  ...
  return (
    <Container>
      ...
      <Context>
        <Title>Edite as Informações do Local</Title>
        ...
        <Button title="Editar" onClick={handleSignUpBarber} />

...
from Projeto.Login_Autenticacao.models import Barbeiro
...
CREDENTIALS_PATH = os.path.join(BASE_DIR, 'Gestao_Agendamento', 'credentials.json')
TOKEN_PATH = os.path.join(BASE_DIR, 'Gestao_Agendamento', 'token.json')
